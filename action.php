...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_price, a.discount, a.product_desc,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.product_id,a.product_title,a.product_price, a.discount, a.product_image,a.product_desc,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				$p_discount=$product_price*$discount;
				$qty = $row["qty"];
				$product_price= $product_price-$p_discount;
	               ...
	               <table id="cart" class="table table-hover table-condensed" id="">
    				<thead>
						<tr>
							...
							<th style="width:8%">GET Discount</th>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@crm.com">
