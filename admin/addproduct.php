...
mysqli_query($con,"insert into products (product_cat, discount,buy_one_get_one,product_title,product_price, product_desc, product_image,product_keywords) values ('$product_type','$discount','$buy_one_get_one','$product_name','$price','$details','$pic_name','$tags')") or die ("query incorrect");
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="number" id="product_type" name="product_type" required="[1-5]" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select id="b_x_g_y"   name="b_x_g_y" required class="form-control">
