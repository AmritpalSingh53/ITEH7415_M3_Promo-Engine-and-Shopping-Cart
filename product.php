							...
							<div class="product-options">
								<label>
									...
									<select class="input-select">
										<option value="0">200 ml</option>
										<option value="0">500 ml</option>
									</select>
								</label>
							</br>
								<label>Discount :<h4 class="product-price">'.$row['discount'].' %</h4></label>
								<label>BUY 1 GET :<h4 class="product-price">'.$row['buy_one_get_one'].' FREE</h4></label>
							</div>
