...
<form action="reset_password.php" method="post" id="contactForm">
<div class="row">
...
<input type="email" name="email" id="email" value=" <?php echo $row["email"];?>" class="form-control"  placeholder="<?php echo $row["email"];?>" readonly>
 ...
 <div class="col-lg-12">
<div class="form-group">
<input type="password" name="pwd1" class="form-control" placeholder="New Password" maxlength="8"  required="required">
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
<input type="password" name="pwd2" class="form-control" placeholder="Confirm Password" maxlength="8" required="required">
</div>
</div>
<div class="col-lg-12 col-md-12">
<button type="submit" value="submit" class="default-btn border-radius-5">
Save Change
</button>
</div>
</div>
...
<div class="col-md-6">
			...
			$copun=$row2["name"];
			    ...
			    <form action="generate-coupon.php" method= "post" id="generateCouponCodeForm">
			    	<div class="form-group">
					    <label for="email">Coupon Code for new users</label>
                       
					    <input class="form-control" value="<?php echo $copun; ?>" type="text" name="coupon-code" readonly="readonly">
						<input type="hidden" value="<?php $userid  ?>">
				  	</div>
